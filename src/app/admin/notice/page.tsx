...
export default function ManageNoticePage() {
  ...
  const handleOpenDialog = (notice: NoticeData | null) => {
    ...
    if (notice) {
      ...
      form.reset({ title: "", content: "", isActive: false, link: "" });
    }
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 py-4">
                ...
                <FormField control={form.control} name="content" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Textarea className="min-h-[150px]" {...field} disabled={isSubmitting} /></FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
                 <FormField control={form.control} name="link" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Input {...field} placeholder="https://example.com/details" disabled={isSubmitting} /></FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
